...
/**
 * Block Name: Internal Tools Widget
 *
...
$block_type = get_field('internal_tools_block_types');

?>
<?php

if($block_type=='policy_grid') { 
...
<div class="<?= $uid; ?> <?= $className; ?>">
    ...
    <div class="row text-start <?= $columns_per_row === 5 ? 'row-cols-lg-5' : '' ?>">
        <?php
...
<?php if($block_type=='policy_grid_search') { 
...
<?php if( $block_type=='email_signature' ) { 
    ...
    <div id="<?= $uid; ?>" class="<?= $className; ?>">
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <div>
                    <h4 class="mt-0">Enter your information</h4>
                    <p>
                        Please refer to the instructions before you begin.
                    </p>
                    <div class="my-3">
                        <a class="btn btn-primary" href="https://internal-tools.rxo.com/wp-content/uploads/sites/2/2022/11/RXO-Email_Signature_Guidelines.pdf" target="_blank">
                            Download Here
                        </a>
                    </div>
                    <p>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="fs-legal mb-2">Format: 11215 North Community House Road</p>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="fs-legal mb-2">Format for US and Canada: Charlotte, NC 28277</p>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="fs-legal mb-2">Country code added automatically for US and Canada. Include country code elsewhere.</p>
                        <input type="text" class="form-control" id="phone">
                        <span id="phone_instructions" class="fs-legal d-none">Use this exact format in North America 800-123-4567.</span>
                    </div>
                    <div class="mb-3">
                        <label for="mobile" class="form-label">Enter Your Mobile Phone:</label>
                        <p class="fs-legal mb-2">Country code added automatically for US and Canada. Include country code elsewhere.</p>
                        <input type="text" class="form-control" id="mobile">
                        <span id="mobile_instructions" class="fs-legal d-none">Use this exact format in North America 800-123-4567.</span>
                    </div>
                    <input type="submit" value="Submit" class="btn btn-primary" id="submit-btn-primary" />
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="d-none" id="rightContent">
                    ...
                    <!-- Signature output -->
                    <div class="bg-light border p-4 rounded my-5">
                        <div id="desktop_signature"></div>
                    </div>
                    <button type="button" data-clipboard-action="copy" data-clipboard-target="#desktop_signature" class="btn btn-secondary btn-copy mb-4">
                        Copy Output&nbsp;&nbsp;
                    </button>
                    <p>
                    ...
                    <button type="button" data-clipboard-action="copy" data-clipboard-target="#desktop_html_signature" class="btn btn-secondary btn-copy mb-4">
                        Copy HTML
                    </button>
                </div>
            </div>
...
<script>
    function RxoSignatureTool(el) {
        ...
        function buildSignature() {
            ...
            signature += '<table cellpadding="0" cellspacing="0" style="border:0pt;background:none;">';
            signature += '<tbody style="border:0pt;"><tr style="border:0pt;">';
            signature += '<td style="width:450pt;font-family:Arial,sans-serif;font-size:8.5pt;color:#000001;line-height:9.75pt;border:0pt;">';
            signature += '<b style="font-family:Arial,sans-serif;font-size:10pt;">' + emplNameVal + '</b>';
            ...
            signature += '<br>';
            signature += '<b style="line-height: 8.5pt;display: block;">&nbsp;</b>';
            signature += '<table cellpadding="0" cellspacing="0" style="border:0pt;padding: 0pt;margin: 0pt;"><tbody style="border:0pt;"><tr style="border:0pt;"><td style="line-height: 1.5pt;display: block;background-color: #00f49c;width: 80pt;height: 1.5pt;border: none;"></td></tr></tbody></table>';
            signature += '<br>';
            signature += '<b style="font-family:Arial,sans-serif;font-size:12pt;line-height:13.5pt;">RXO</b>';
            ...
            document.getElementById('submit-btn-primary').value = 'Re-Submit';
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const rxoSignToolEl = document.querySelector('#<?= $uid; ?>');
...
<?php if($block_type=='interview_questions') {
...
?>
    ...
    <div id="<?= $uid; ?>" class="<?= $className; ?> rxo-block-interview-questions">
        <div class="container position-relative py-6">
        <div class="row">
        ...
        <div id="block4" class="col-12 --show-in-pdf" style="display:none">
            <div class="pdf-content-block">
                <div class="PDF-header-section"> <img height="24" src="<?= get_site_url(); ?>/wp-content/themes/rxo/images/rxo-logo.svg" class="custom-logo" alt="RXO | Massive capacity. Cutting-edge technology.">
                ...
                <table class="PDF-table" nobr="true">
                    ...
                    <tbody>
                        <tr>
                            <td class="PDF-cell PDF-cell--highlighted text-center">1</td>
                            <td class="PDF-cell PDF-cell--highlighted text-center">2</td>
                            <td class="PDF-cell PDF-cell--highlighted text-center">3</td>
                            <td class="PDF-cell PDF-cell--highlighted text-center">4</td>
                            <td class="PDF-cell PDF-cell--highlighted text-center">5</td>
                        </tr>
                        <tr class="PDF-checkboxes">
                            <td class="PDF-cell PDF-cell--highlighted text-center"><span class="PDF-checkbox">&nbsp;</span></td>
                            <td class="PDF-cell PDF-cell--highlighted text-center"><span class="PDF-checkbox">&nbsp;</span></td>
                            <td class="PDF-cell PDF-cell--highlighted text-center"><span class="PDF-checkbox">&nbsp;</span></td>
                            <td class="PDF-cell PDF-cell--highlighted text-center"><span class="PDF-checkbox">&nbsp;</span></td>
                            <td class="PDF-cell PDF-cell--highlighted text-center"><span class="PDF-checkbox">&nbsp;</span></td>
                        ...
                        <tr>
                            <td class="PDF-cell PDF-cell--highlighted text-center" colspan="2">Little to No Demonstration of Capability</td>
                            <td class="PDF-cell PDF-cell--highlighted text-center">Demonstrates Capability</td>
                            <td class="PDF-cell PDF-cell--highlighted text-center" colspan="2">Consistently Demonstrates Capability</td>
                        </tr>
                        <tr>
    ...
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        selectInputs = document.querySelectorAll('#<?= $uid; ?> .js-choice');
        [].forEach.call(selectInputs, function(sEl, i) {
            let choices = new Choices(sEl, {
                allowHTML: true,
                placeholderValue: '',
