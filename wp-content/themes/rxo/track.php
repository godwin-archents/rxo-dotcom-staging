...
<main id="primary" class="site-main">
    ...
    <div class="container py-6">
        <div class="row">
            <div class="col-12">
                <form class="align-items-center border-2 border-bottom border-primary-dark d-flex" action="<?php echo esc_url(home_url('/devtrack')); ?>" method="GET">
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        foreach ($shipmentInfoRowData['row_items'] as $shipmentInfoDetailData) { ?>
                                                            ...
                                                            <?php if (trim($shipmentInfo['table_head'][$k]) == "") {  ?>
                                                                ...
                                                                ?>
                                                                <p class="mb-1"><a href="<?php echo esc_url(home_url('/devtrack')); ?>?trackingNumber=<?php echo $item_track; ?>" class="text-black text-decoration-underline">View Additional Details</a></p>
                                                            <?php } ?>
                                                        <?php $k++;
                                                        } ?>
                                                    </div>
            ...
            <div class="row mb-7">
                <div class="col-12 col-md-11 col-lg-10 col-xl-9 mx-auto">
                    ...
                    ?>
                        ...
                        <form class="align-items-center" action="<?php echo esc_url(home_url('/devtrack')); ?>" method="GET">
                            <div class="w-100">
