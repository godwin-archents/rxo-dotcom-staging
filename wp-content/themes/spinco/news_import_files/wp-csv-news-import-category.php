...
function searchForId($id, $array) {
 ...
 /* Process Start Here */
    ...
    if($data[0]!='id'){
        ...
        $en_Full_Array[$data[0]][$i]['category'] = $data[14];
        $i++;            
        if($data[1]=='en') {
            $en_Array[] = $data[0];
        }
...
/* * /    
    ...
    foreach($en_Array as $en_Array_Value){
        ...
        echo "<hr/>";
        echo "CATEGORY: ";
        echo $title=$en_Full_Array[$en_Array_Value][$firstKey]['category'];
        echo "<hr/>";
        $rc=1;
        ...
        if($LangKey>0){
            ...
            echo " : ES :";
            echo $textNew=$en_Full_Array[$en_Array_Value][$LangKey]['category'];
            $rc++;
            echo " <br/> ";
        }
...
/* */
    ...
    foreach($en_Array as $en_Array_Value){
        ...
        echo "<hr/>";
        echo "CATEGORY: ";
        echo $text=$en_Full_Array[$en_Array_Value][$firstKey]['category'];
        echo "<hr/>";   
