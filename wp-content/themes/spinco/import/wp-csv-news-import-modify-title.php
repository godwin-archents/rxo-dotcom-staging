    ...
    */
    ...
    foreach($en_Array as $en_Array_Value){
        ...
        if($postID){            
            ...
            echo "<hr/>";
            $short_title_info = update_Post_Info($short_title,$postID);
            //$short_title_info = 1;
            echo "AFFECTED ROW: ".$short_title_info;
            echo "<hr/>";
            echo "REPLACETITLE: ";
            ...
            //$text = str_replace('&quot;','&#8221;',$text);
            $text = replace_first_str('&quot;','&#8220;',$text);
            $text = replace_last_str('&quot;','&#8221;',$text);
            echo "ENCODE-REPLACETITLE: ";
            echo $text;  
            echo "<hr/>"; 
            ...
            if($originalID){
                ...
                if($metaID){
                    ...
                    echo " : DE :";
                    echo $textNew=$en_Full_Array[$en_Array_Value][$LangKey]['short_title'];
