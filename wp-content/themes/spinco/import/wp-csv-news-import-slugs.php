 ...
 /* Process Start Here */
    ...
    */
    ...
    foreach($en_Array as $en_Array_Value){
        ...
        echo "<hr/>";
        echo "SLUG: ";
        echo $text=$en_Full_Array[$en_Array_Value][$firstKey]['slug'];
        echo "<hr/>";   
        $originalID = insert_Trp_Original_Strings($text);
            if($originalID){
                ...
                if($metaID){
                    ...
                    $metaKey = "_trp_translated_slug_de_DE";

                    $LangKey = array_search('pt', array_column($en_Full_Array[$en_Array_Value], 'locale'));
                    echo "<hr/>";
                    echo  $LangKey=$LangKey+$lc;
                    echo " : DE :";
                    echo $textNew=$en_Full_Array[$en_Array_Value][$LangKey]['slug'];
                    $TransID = insert_Trp_Dictionary_Slug($text,$textNew,$originalID,$tableName,$metaKey,$postID);
                    echo " : DE TransID::".$TransID;
                    echo "<hr/>";
                }
                if($metaID){
                    $tableName = "trp_dictionary_en_us_es_es";
                    $metaKey = "_trp_translated_slug_es_ES";
                ...
                if($metaID){
                    ...
                    $metaKey = "_trp_translated_slug_fr_FR";
                ...
                if($metaID){
                    ...
                    $metaKey = "_trp_translated_slug_it_IT";
                ...
                if($metaID){
                    ...
                    $metaKey = "_trp_translated_slug_nl_NL";
                ...
                if($metaID){
                    ...
                    $metaKey = "_trp_translated_slug_pl_PL";
