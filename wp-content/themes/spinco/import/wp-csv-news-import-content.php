...
function insert_Trp_Dictionary($inputdata1,$inputdata2,$inputdata3,$tabledata) {
    ...
    $exp_array=array('youtube','linkedin','facebook','twitter','forward-looking statements');
    ...
    foreach($en_Array as $en_Array_Value){
        ...
        if($postID){
            ...
            */    
            ...
            echo " : DE :";
            $text_DE=$en_Full_Array[$en_Array_Value][$LangKey]['article'];
            $deArrayValue = extract_page($text_DE);

            echo "<hr/>";
            print_r($deArrayValue);
            echo "<hr/>";
            /* END DE LANG */
            ...
            echo  $LangKey=$LangKey+$lc;
            echo " : ES :";
            $text_ES=$en_Full_Array[$en_Array_Value][$LangKey]['article'];
            $esArrayValue = extract_page($text_ES);

            echo "<hr/>";
            print_r($esArrayValue);
            echo "<hr/>";
            /* END ES LANG */
            ...
            echo  $LangKey=$LangKey+$lc;
            echo " : IT :";
            $text_IT=$en_Full_Array[$en_Array_Value][$LangKey]['article'];
            $itArrayValue = extract_page($text_IT);

            echo "<hr/>";
            print_r($itArrayValue);
            echo "<hr/>";
            /* END IT LANG */
            ...
            echo  $LangKey=$LangKey+$lc;
            echo " : PL :";
            $text_PL=$en_Full_Array[$en_Array_Value][$LangKey]['article'];
            $plArrayValue = extract_page($text_PL);

            echo "<hr/>";
            print_r($plArrayValue);
            echo "<hr/>";
            /* END PL LANG */
