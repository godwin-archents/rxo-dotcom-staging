...
$(document).ready(function () {
    $("button.js-add-capability-button").click(function () {
        ...
        $("#capability" + dataId).append('<div class="align-items-baseline d-flex"><a href="javascript:void(0);" data-id="' + dataId + '" data-name="' + dataName + '" class="js-remove-section border-0 btn p-0"></a><p class="ps-1">' + dataDesc + '</p></div>');
...
$(document).ready(function () {
    $("button.js-add-primary-question-button").click(function () {
        ...
        $("#capability" + dataId).append('<div id="questiontitle' + dataQuestionId + '" class="questiontitle align-items-baseline d-flex"><a href="javascript:void(0);" data-id="' + dataId + '" data-qid="' + dataQuestionId + '" class="js-remove-question btn p-0 text-black text-start"></a><p class="ps-1">' + dataQuestionName + '</p></div>');
...
function newItem(Key) {
    ...
    newInput += '<tbody>';
    newInput += '<tr>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi">1</td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi">2</td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi">3</td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi">4</td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi">5</td>';
    newInput += '</tr>';
    newInput += '<tr class="PDF-checkboxes">';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi"><span class="PDF-checkbox">&nbsp;</span></td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi"><span class="PDF-checkbox">&nbsp;</span></td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi"><span class="PDF-checkbox">&nbsp;</span></td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi"><span class="PDF-checkbox">&nbsp;</span></td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi"><span class="PDF-checkbox">&nbsp;</span></td>';
    newInput += '</tr>';
    newInput += '<tr>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi" colspan="2">Little to No Demonstration of Capability</td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi">Demonstrates Capability</td>';
    newInput += '<td class="PDF-cell PDF-cell--highlighted text-center font-demi" colspan="2">Consistently Demonstrates Capability</td>';
    newInput += '</tr>';
    newInput += '</tbody>';
    newInput += '</table>';
    newInput += '<div class="html2pdf__page-break"></div>';
