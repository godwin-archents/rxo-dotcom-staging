=== Complianz Privacy Suite (GDPR/CaCPA) premium multisite ===
...
* Fix: multisite copy to subsites banner css generation
...
= 6.0.9 =
* Fix: detected duplicate upgrade in banner
...
* Improvement: single site license block hidden on multisite
...
* Fix: multisite copy feature not working due to nonce name change
...
= 5.0.2.1 =
* Fix: css for privacy policy summary/details
...
= 4.8.2 =
* Fix: missing networkwide license page
...
= 4.7.1 =
* When copying sites over to subsites, copy pages as well
...
= 3.0.4.2 =
* Fix: multisite import

= 3.0.4 =
* Fix: expiry days not passed to cookiebanner
...
= 2.0.1 =
* Tweak: latest cookie database changes
...
* Feature: Do Not Sell My Personal Data page
* Feature: Do Not Sell My Personal Data opt out form & dashboard
